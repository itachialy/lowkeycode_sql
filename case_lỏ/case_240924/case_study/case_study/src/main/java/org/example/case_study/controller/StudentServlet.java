...
public class StudentServlet extends HttpServlet {
    ...
    private void filterStudents(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Student> list = iStudentService.filterStudent(name, className);
    ...
    public void forwardCreateForm(HttpServletRequest request, HttpServletResponse response, String name, Date birthday,
                                  int gender, String email, double point, int classId) throws ServletException, IOException {
