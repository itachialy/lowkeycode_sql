...
<!-- Hiển thị thông báo login thành công nếu có -->
<c:if test="${not empty sessionScope.loginMessage}">
    <div class="alert alert-success alert-dismissible fade show mx-auto" style="max-width: 400px; text-align: center;" role="alert">
            ...
            <form action="?action=filter" method="get" class="form-inline d-flex">
                ...
                <label>
                    <select name="className" class="form-control ml-2">
                        <option value="all" id="className" name="className">Chọn lớp</option> <!-- Tùy chọn mặc định -->
